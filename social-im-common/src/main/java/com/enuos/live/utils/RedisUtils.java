...
//     * @return
//     */
//    public long zSet(String key, Set values) {
//        try {
...
//     * @param key   键
//     * @param value 值
//     * @param rank  排名顺序 默认从小到大
//     * @return
//     */
//    public long zRank(String key, Object value, Integer rank) {
//        try {
//            if (1 == rank) { // 从大到小
...
//     * @return
//     */
//    public Map<HK, HV> getHash(String key) {
//        return redisTemplate.opsForHash().entries(key);
//    }
//
//    /**
