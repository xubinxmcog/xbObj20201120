package com.enuos.live.handle.match.f30001;
 ...
 * @version V1.0.0
 * @since 2020/5/21 17:07
 */

@Component
@AbstractAction(cmd = 100001)
public class F30001Match extends AbstractActionHandler {

  /**
   * 游戏编码.
   */
  private static final int GAME_CODE = 30001;
  /**
   * 超时时间(30s).
   */
  ...
  private static ScheduledExecutorService executor = new ScheduledThreadPoolExecutor(1,
      new BasicThreadFactory.Builder().namingPattern("robotUp-30001-%d").daemon(true).build());

  // 初始化计时器 延时1秒启动，每3秒扫描一次
  {
