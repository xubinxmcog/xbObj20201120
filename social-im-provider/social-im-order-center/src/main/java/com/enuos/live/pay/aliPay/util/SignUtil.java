package com.enuos.live.pay.aliPay.util;
...
//                if (StrUtil.isNotEmpty(key) && !ArrayUtil.contains(ignoreKeys, key)
//                        && (!ignoreEmptyValue || StrUtil.isNotEmpty(value))) {
    ...
    public static TreeMap<String, String> bean2TreeMap(Object bean) {
        ...
        try {
            for (int i = 0; i < fields.length; i++) {
                ...
                if ("sign".equals(key) || value == null || StrUtil.isEmpty(value.toString())) {
                    continue;
                }
