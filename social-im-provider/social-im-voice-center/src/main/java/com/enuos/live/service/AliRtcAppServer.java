...
/**
 * @ClassName AliRtcAppServerToken
 * @Description: TODO
 * @Author xubin
 * @Date 2020/6/17
 * @Version V1.0
 **/
public class AliRtcAppServer {
    ...
    private String nonce; // 随机码
    private Long timestamp; // 过期时间戳
...
//        try {
//            new AliRtcAppServer().run(args);
//        } catch (Exception e) {
//            System.out.println(e);
//        }
//        try {
//            System.out.println(createToken("f2of5r2z","cdd54e45b8882494edc8ef376f42fe45","123","118651485","AK-25c2d38c409c376ffd2372be1",System.currentTimeMillis()+1209600000));
//        } catch (NoSuchAlgorithmException e) {
//            e.printStackTrace();
//        }

        System.out.println( createUserID("R_648836", "109028876"));
    }
}
